				...
				<div class="row-fluid">
					<!-- block -->
						...
						<div class="navbar navbar-inner block-header">
							<div class="muted pull-left">${student.realName}信息</div>
						</div>
								...
								<div class="wrap-list">
									<div class="list-main set-main user-info"
										...
										<div class="set-box">
											...
											<input type="text" name="nickname" value="${student.realName}">
										</div>
										
										<div class="set-box">
											<label class="box-title">学号：</label>
											<input type="text" name="nickname" value="${student.userName }">
										</div>
										
											<div class="set-box">
											<label class="box-title">班级：</label>
											<input type="text" name="nickname" value="${student.gradeId}">
										</div>
											...
											<input type="text" name="nickname" value="${student.birthday }">
										</div>
										
											<div class="set-box">
											<label class="box-title">电话：</label>
											<input type="text" name="nickname" value="${student.phoneNum }">
										</div>
										
											<div class="set-box">
											<label class="box-title">地址：</label>
											<input type="text" name="nickname" value="${student.address }">
										</div>
									</div>
								</div>
							</div>
