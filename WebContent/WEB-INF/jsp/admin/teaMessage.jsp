				...
				<div class="row-fluid">
					<!-- block -->
						...
						<div class="navbar navbar-inner block-header">
							<div class="muted pull-left">${teacher.realName}信息</div>
						</div>
								...
								<div class="wrap-list">
									<div class="list-main set-main user-info"
										...
										<div class="set-box">
											...
											<input type="text" name="nickname" value="${teacher.realName}">
										</div>
										
										<div class="set-box">
											<label class="box-title">工号：</label>
											<input type="text" name="nickname" value="${teacher.userName }">
										</div>
											...
											<input type="text" name="nickname" value="${teacher.birthday }">
										</div>
										
											<div class="set-box">
											<label class="box-title">电话：</label>
											<input type="text" name="nickname" value="${teacher.phoneNum }">
										</div>
										
											<div class="set-box">
											<label class="box-title">地址：</label>
											<input type="text" name="nickname" value="${teacher.address }">
										</div>
									</div>
								</div>
							</div>
