						...
						<div class="block-content collapse in">
							...
							<div class="span12">
								...
								<table cellpadding="0" cellspacing="0" border="0"
									...
									<c:forEach items="${assessCourses}" var="data" varStatus="status">
										<tr>
											<td>${status.index + 1}</td>
											<td>${data.courseName}</td>
											<td>${data.clazzId}</td>
											<td class="center">${data.scoreAverage}</td>
											<td>
												<a href="teacher/service/assessClazz?courseId=${data.courseId }&clazzId=${data.clazzId}" data-toggle="modal"
