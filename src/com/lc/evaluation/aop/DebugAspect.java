...
public class DebugAspect {
	 ...
	 *            连接点：程序执行过程中的某一行为
	 */
	@Pointcut("execution(public * com.lc.evaluation.control.admin.*.login(..))"
			+ "|| execution(public * com.lc.evaluation.control.student.*.login(..))"
			+ "|| execution(public * com.lc.evaluation.control.teacher.*.login(..))")
	private void myMethod() {
	}// 定义一个切入点

	public DebugAspect() {
//		System.out.println("logAsp");
	}
